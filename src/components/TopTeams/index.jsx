    ...
    return (
        <ul className={styles.teamList}>
            {teams.map(({team, image, country, points}) => (
                <li>
                    <img src={image} className={styles.teamLogo} alt="Team Logo" />
                    <div className={styles.teamInfo}>
                        <div className={styles.teamInfoHeader}>
                            <img src={country} alt="Team Flag" className={styles.teamFlag}/>
                            <span className={styles.teamName}>{team}</span>
                        </div>
                        <span className={styles.teamPoints}>{points} points</span>
                    </div>
